...
<head>
    ...
    <title>Edit Product - Asetik</title>
    <style>
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control @error('name') error @enderror" value="{{ old('name', $product->name) }}" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    @if($product->photo)
                        <div style="margin-bottom: 10px;">
                            <img src="{{ asset($product->photo) }}" alt="Current photo" class="photo-preview" style="display: block;">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control @error('description') error @enderror" required>{{ old('description', $product->description) }}</textarea>
                    @error('description')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
