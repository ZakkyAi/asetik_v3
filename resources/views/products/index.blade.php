...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .product-image { width: 60px; height: 60px; object-fit: cover;  border: 1px solid #000; }
        .default-product-image { width: 60px; height: 60px;  background: #fff; color: #000; display: inline-flex; align-items: center; justify-content: center; font-weight: 700; font-size: 24px; }
    </style>
</head>
<body>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="{{ route('admin.products.show', $product->id) }}" class="btn btn-sm btn-view">View</a>
                                    @if(auth()->user()->level === 'admin')
